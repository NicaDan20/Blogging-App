...
var RecaptchaV2 = (function () {
    ...
    RecaptchaV2.prototype.renderWith = function (optionsToOverride) {
        ...
        return '<div class="g-recaptcha" data-sitekey="' + this._site_key + '"' + captcha_attr + '></div>' + 
        '<script src="https://' + recaptcha_host + this._api.script + query_string + 'render=explicit" async defer></script>';
    };
